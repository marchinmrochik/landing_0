		...
		<div class="container">
			<div class="row d-flex justify-content-between align-items-center py-2">
				...
				<div class="d-flex align-items-center">
					...
					<a class="header-p2_link gray-dark_color ml-4" href="#popup:marquiz_5c7a346c2421ab0044839b60">ПРОСЧИТАТЬ ПРОЭКТ</a>
		...
		<div class="row d-flex flex-column">
			<div class="col-lg-8 col-md-12 pl-5">
				...
				<div class="section-about_company-text mb-5">
					<b>“Ск Новые Строительные Технологии”</b>  — это технологичная,
